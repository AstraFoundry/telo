...
export function NumberTicker({
  ...
  // Adaptation: framer's useInView assumes IntersectionObserver exists; the
  // jsdom test environment (and older webviews) do not provide it, so the
  // viewport gate is a guarded effect that arms immediately without one.
  ...
  // reads as lag.
  // Adaptation: with startOnView disabled the reveal is skipped entirely —
  // transcript counters roll on value change, never on mount.
  const [entered, setEntered] = useState(!startOnView);
  useEffect(() => {
